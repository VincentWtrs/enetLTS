enetLTS_OLD <- function(xx, yy, family = c("gaussian", "binomial"), alphas, 
  ...
  # IC check with family (requires "binomial" currently)
  if(!is.null(ic_type)){
    if(family == "gaussian"){
  ...
  } else { # Here ends the scal == TRUE and starts scal == FALSE!
